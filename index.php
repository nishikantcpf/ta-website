...
<body>
    ...
    <div class="container-fluid mt-3">
        ...
        <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
    ...
    <a class="carousel-control-prev" href="#imageCarousel" role="button" data-bs-slide="prev" style="margin: -30px;">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
    </a>
    <a class="carousel-control-next" href="#imageCarousel" role="button" data-bs-slide="next" style="margin: -30px;">
            ...
            <div class="row text-center">
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/1.jpeg" class="img-fluid" alt="e-Task Manager" style="height: 83px;">
                    </a>
                    <p class="mt-2">e-Task Manager</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/2.jpeg" class="img-fluid" style="height: 83px" alt="Army Mail">
                    </a>
                    <p class="mt-2">Army Mail</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/3.jpeg" class="img-fluid" style="height: 83px" alt="e-Library">
                    </a>
                    <p class="mt-2">e-Library</p>
                </div>
                <div class="col">
                    <a target="_blank" href="links/news/index.html">
                        <img src="img/quciklinks/4.PNG" class="img-fluid" style="height: 83px" alt="e-Office">
                    </a>
                    <p class="mt-2">e-Office</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/teledirectory.png" class="img-fluid" style="height: 83px" alt="Directory">
                    </a>
                    <p class="mt-2">Tele Directory</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#" style="height: 30px;">
                        <img src="img/quciklinks/5.jpeg" class="img-fluid" style="height: 83px" alt="Asigma" >
                    </a>
                    <p class="mt-2">Asigma</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/6.jpeg" class="img-fluid" style="height: 83px" alt="Trending Tweets">
                    </a>
                    <p class="mt-2">Trending Tweets</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/7.jpeg" class="img-fluid" style="height: 83px" alt="Innovations">
                    </a>
                    <p class="mt-2">Innovations</p>
                </div>
                <div class="col">
                    <a target="_blank" href="#">
                        <img src="img/quciklinks/8.png" class="img-fluid" style="height: 83px" alt="Cyber News">
                    </a>
